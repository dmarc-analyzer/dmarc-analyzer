...
CREATE TABLE dmarc_reporting_entries (
...
ALTER TABLE ONLY dmarc_reporting_entries
    ADD CONSTRAINT dmarc_reporting_entries_pkey PRIMARY KEY (message_id, record_number);
